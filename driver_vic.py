...
if __name__ == '__main__':
	systemtype = system_type(ccgx_rasp[0]) #sets a ccgx system
	...
	s.Port_sel = ve.args.Bornay_serial
	...
	s.stop_sel = 1
	s.delay = 1
	#s.Port_sel = '/dev/ttyUSB0'
	#init vebus and bornay modbus
	s.init(s.Port_sel, s.delay)
	ve.Init() #init the vebus config and directories #TODO This line must be improved	
	while 1:
